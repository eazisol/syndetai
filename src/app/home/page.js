...
function LandingPageContent() {
 ...
 const heroImages = [
  "/images/home1-new.png",
  "/images/home2-new.png",
  "/images/home3-new.png",
];
  ...
  const campaign_recipient_id =
    searchParams?.get("campaign_recipient_id") || null;
          ...
          <div className="row g-5 align-items-start">
              ...
              >
                {!submitted ? (
                    ...
                    <form className="syndet-form" onSubmit={handleSubmit}>
                      ...
                      {persona === "investor" ? (
                        <>
                          <div className="form-group">
                            <label>
                              <Briefcase size={14} className="me-1" /> Company
                              or Fund Name (Optional)
                            </label>
                            <input
                              type="text"
                              name="fundName"
                          ...
                          <div className="form-group">
                            <label>
                              <Search size={14} className="me-1" /> Company to
                              Research*
                            </label>
                            <input
                              type="text"
                              name="targetCompany"
                              className="form-input"
                              placeholder="Name of target startup"
                              required
                              onChange={handleInputChange}
                            />
                          ...
                          <div className="form-group">
                            <label>
                              <Globe size={14} className="me-1" /> Company
                              Website*
                            </label>
                            <input
                              type="text"
                        ...
                        <>
                          <div className="form-group">
                            <label>
                              <Rocket size={14} className="me-1" /> Company
                              Name*
                            </label>
                            <input
                              type="text"
                  ...
                  >
                    ...
                    {persona === "investor" ? (
                      <p>
                        Thanks, we're preparing your account and your report on{" "}
                        <strong>
                          {formData.targetCompany || "the company"}
                        </strong>
                        . You'll receive an email with login details and your
                        report.
                      </p>
                    ) : (
                      <p>
            ...
            <div className="col-lg-6 order-lg-1">
              <div className="hero-content-split">
                ...
                >
                  SyndetAI leverages advanced AI to provide deep insights for
                  investors and founders, turning data into actionable
  ...
  <AnimatePresence mode="wait">
    ...
    >
      <Image
        ...
        alt={`Preview ${currentHeroImage + 1}`}
        fill
  ...
  >
    <ChevronRight size={20} />
      ...
      <footer className="py-5 text-center text-muted border-top bg-white">
        <div className="container">
          <p className="mb-0">
            © {new Date().getFullYear()} SyndetAI. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
